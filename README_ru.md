...
[English](README.md) | [История изменений](CHANGELOG.ru.md)
...
4. Нажмите **Бенчмарки**, чтобы открыть окно сравнения: выберите прогоны, сравните их бок о бок в Markdown-таблицах, сузьте таблицу фильтром **Строки**, сохраняйте именованные наборы сравнения (прогоны + выбор строк) и экспортируйте отчёты в `.md`
